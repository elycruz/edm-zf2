    ...
    function initRowControls()
    {
        ...
        $('.list-order-control').each(function() {
            ...
            o.listOrderControl({setListOrderCallback: function(data) {
                url = '/edm-admin/post/set-list-order/id/' + id + 
            ...
            $('.term-taxonomy-control').each(function() {
                ...
                o.termTaxonomyControl({
                    ...
                    onChangeCallback: function(data) {
                        $.get('/edm-admin/post/set-category/format/json' +
                            '/id/' + id +
                            '/category_id/' + data.value, function(data2) {
                                trace(var_dump(data2));
                            });
                    }
                });
        ...
        $.get('/edm-admin/term-taxonomy/get/taxonomyFilter' +
            ...
            $('.status-control').each(function() {
                ...
                o.termTaxonomyControl({
                    ...
                    onChangeCallback: function(data) {
                        $.get('/edm-admin/post/set-status/format/json' +
                            '/id/' + id +
...
//            <td>1.</td>
//            <td><a href="/edm-admin/post/update/id/23" class="title font-georgia">title</a></td>
//            <td>post</td>
//            <td class="term-taxonomy-control"></td>
//            <td class="status-control"></td>
//            <td class="list-order-control">
//                <a class="next-btn" href="/edm-admin/post/set-list-order/id/23/format/json/listOrder/24">
//                    <span>Up</span></a> |
//                <a class="prev-btn" href="/edm-admin/post/set-list-order/id/23/format/json/listOrder/26">
//                    <span>Down</span></a> |
...
//            <td class="crud-control"><a href="/edm-admin/post/update/id/23" title="edit">edit</a>|
//                    <a href="/edm-admin/post/delete/id/23" title="delete">delete</a>    
//            </td>
//        </tr>
    }
